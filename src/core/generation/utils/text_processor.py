...
class TextProcessor:
    ...
    def _initialize_license_patterns(self) -> Dict[str, str]:
        ...
        return {
            ...
            "CERN-OHL-S-2.0": r"cern\s+open\s+hardware\s+licen[cs]e.*strongly.reciprocal|cern\s+ohl[.\-\s]+s",
            "CERN-OHL-P-2.0": r"cern\s+open\s+hardware\s+licen[cs]e.*permissive|cern\s+ohl[.\-\s]+p",
            "CERN-OHL-W-2.0": r"cern\s+open\s+hardware\s+licen[cs]e.*weakly.reciprocal|cern\s+ohl[.\-\s]+w",
