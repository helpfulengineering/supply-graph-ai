...
class TextProcessor:
    ...
    def _initialize_content_type_patterns(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            'operating_instructions': [
                'operation', 'operate', 'usage', 'use', 'manual', 'user guide',
                'how to use', 'getting started', 'quick start'
            ],
            'manufacturing_instructions': [
                'manufacturing', 'production', 'fabrication', 'make', 'create',
                'manufacture', 'produce', 'fabricate'
            ],
            'technical_specifications': [
                'specification', 'spec', 'technical', 'dimensions', 'tolerance',
                'parameter', 'requirement', 'standard'
            ],
            'troubleshooting': [
                'troubleshoot', 'troubleshooting', 'problem', 'issue', 'error',
                'fix', 'solution', 'debug', 'diagnose'
            ],
            'safety_instructions': [
                'safety', 'warning', 'caution', 'danger', 'hazard', 'risk',
                'precaution', 'protective', 'ppe'
            ],
            'maintenance': [
                'maintenance', 'maintain', 'service', 'repair', 'calibrate',
    ...
    def _initialize_complexity_indicators(self) -> Dict[str, List[str]]:
        ...
        return {
            'beginner': [
                'simple', 'easy', 'basic', 'beginner', 'introductory', 'starter',
                'no experience', 'no prior knowledge', 'straightforward'
            ],
            'intermediate': [
                'intermediate', 'moderate', 'some experience', 'basic knowledge',
                'familiar with', 'comfortable with', 'standard'
            ],
            'advanced': [
                'advanced', 'expert', 'complex', 'sophisticated', 'professional',
                'experienced', 'skilled', 'technical', 'specialized'
            ]
        }
    ...
    def extract_measurements(self, text: str) -> List[Dict[str, str]]:
        ...
        measurement_pattern = r'(\d+(?:\.\d+)?)\s*(mm|cm|m|inch|inches|in|ft|feet|ft|°|deg|degrees)'
    ...
    def is_technical_content(self, text: str) -> bool:
        ...
        technical_terms = [
            'specification', 'dimension', 'tolerance', 'parameter', 'voltage',
            'current', 'resistance', 'frequency', 'wavelength', 'temperature',
            'pressure', 'force', 'torque', 'speed', 'rpm', 'accuracy', 'precision',
            'calibration', 'measurement', 'sensor', 'actuator', 'controller',
            'algorithm', 'protocol', 'interface', 'api', 'database', 'software',
            'hardware', 'firmware', 'circuit', 'schematic', 'pcb', 'component'
        ]
