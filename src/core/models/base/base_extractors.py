...
class BaseExtractor(ABC):
    ...
    ) -> ExtractionResult[NormalizedRequirements]:
    ...
    def extract_capabilities(
        self, content: Dict[str, Any]
    ) -> ExtractionResult[NormalizedCapabilities]:
    ...
    def _validate_and_refine_capabilities(
        self, extracted_data: NormalizedCapabilities
    ) -> NormalizedCapabilities:
        """Validate and refine extracted capabilities data"""
        return extracted_data

    def _assess_extraction_quality(
        self, extraction_result: ExtractionResult, extraction_type: str
    ) -> None:
        ...
        if not low_confidence_fields:
            ...
            extraction_result.metadata.extraction_quality = (
