...
class OKHManifest:
    ...
    organization: Optional[Union[str, Organization, List[Union[str, Organization]]]] = None
    ...
    def to_dict(self) -> Dict:
        ...
        organization_dict = self._convert_agent_to_dict(self.organization) if self.organization else None
        ...
        optional_fields = {
            ...
            "contributors": [c.to_dict() for c in self.contributors] if self.contributors else None,
            ...
            "manufacturing_specs": self.manufacturing_specs.to_dict() if self.manufacturing_specs else None,
            "bom": self.bom,
    ...
    def _convert_agent_to_dict(self, agent):
        ...
        if isinstance(agent, str):
            ...
            return [a.to_dict() if isinstance(a, (Person, Organization)) else a for a in agent]
        return None
    ...
    def from_dict(cls, data: Dict) -> 'OKHManifest':
        ...
        for field in [
            ...
            'health_safety_notice', 'image', 'readme', 'contribution_guide',
            'development_stage', 'attestation', 'technology_readiness_level',
        ...
        for doc_field in ['manufacturing_files', 'design_files', 'making_instructions', 'operating_instructions', 'technical_specifications', 'publications']:
            if doc_field in data:
                ...
                for doc_data in data[doc_field]:
                    doc_type = DocumentationType(doc_data.get('type', DocumentationType.DESIGN_FILES.value))
                    doc = DocumentRef(
