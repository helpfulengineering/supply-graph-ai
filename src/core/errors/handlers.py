...
class ErrorHandler:
    ...
    def _log_error(
        self, error: Exception, error_info: Dict[str, Any], severity: ErrorSeverity
    ):
...
class LLMErrorHandler(ErrorHandler):
    ...
    def handle_llm_error(
        ...
        context = context or {}
        context.update(
            {"provider": provider, "operation": operation, "error_key": error_key}
        )
    ...
    def _handle_rate_limit_error(
        self, error: LLMRateLimitError, provider: str, context: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _handle_timeout_error(
        self, error: LLMTimeoutError, provider: str, context: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _handle_auth_error(
        self, error: LLMAuthenticationError, provider: str, context: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _handle_generic_llm_error(
        self, error: LLMError, provider: str, context: Dict[str, Any]
    ) -> Dict[str, Any]:
...
def get_error_handler(
    component_name: str, handler_type: str = "generic"
) -> ErrorHandler:
    """
