...
class OKHMatcher(BaseMatcher):
    ...
    def match(
        ...
        confidence = self._calculate_confidence(
            matched_capabilities, missing_requirements, substitutions, len(requirements)
        )
    ...
    def generate_supply_tree(
        self, okh_manifest: OKHManifest, capabilities: List[Capability]
    ) -> SupplyTree:
    ...
    def _find_capability(
        self, requirement: OKHRequirement, capabilities: List[Capability]
    ) -> Optional[Capability]:
    ...
    def _can_satisfy(self, requirement: OKHRequirement, capability: Capability) -> bool:
        ...
        if (
            "processes" in capability.parameters
            and requirement.name in capability.parameters["processes"]
        ):
            return True
    ...
    def _can_substitute(
        self, requirement: OKHRequirement, capability: Capability
    ) -> bool:
        """
    ...
    def _check_specification_match(
        self, requirement: OKHRequirement, capability: Capability
    ) -> bool:
        """
