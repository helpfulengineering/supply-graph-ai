...
class ManufacturingOKWValidator(Validator):
    ...
    async def _validate_field_content(self, facility: ManufacturingFacility, 
    ...
    async def _validate_facility_status(self, facility: ManufacturingFacility, 
                                      quality_level: str, result: ValidationResult):
        """Validate facility status"""
    ...
    async def _validate_location(self, facility: ManufacturingFacility, 
                              quality_level: str, result: ValidationResult):
        """Validate location information"""
    ...
    async def _validate_equipment(self, facility: ManufacturingFacility, 
                                quality_level: str, result: ValidationResult):
    ...
    async def _validate_equipment_item(self, equipment: Any, index: int, 
                                     quality_level: str, result: ValidationResult):
    ...
    async def _validate_manufacturing_processes(self, facility: ManufacturingFacility, 
                                              quality_level: str, result: ValidationResult):
        """Validate manufacturing processes"""
        
        if not hasattr(facility, 'manufacturing_processes') or not facility.manufacturing_processes:
            if quality_level in ['professional', 'medical']:
                result.add_error(
    ...
    async def _validate_materials(self, facility: ManufacturingFacility, 
                                quality_level: str, result: ValidationResult):
    ...
    async def _validate_material_item(self, material: Any, index: int, 
                                    quality_level: str, result: ValidationResult):
    ...
    async def _validate_certifications(self, facility: ManufacturingFacility, 
                                     quality_level: str, result: ValidationResult):
        """Validate certifications and quality standards"""
    ...
    def _calculate_capability_score(self, facility: ManufacturingFacility, quality_level: str) -> float:
        ...
        # Process bonus
        if hasattr(facility, 'manufacturing_processes') and facility.manufacturing_processes:
    ...
    async def _add_optional_field_warnings(self, facility: ManufacturingFacility, 
                                         quality_level: str, result: ValidationResult):
        """Add warnings for missing optional fields"""
    ...
    def _is_valid_facility_type(self, facility_type: str) -> bool:
        ...
        valid_types = [
            "machine_shop", "fab_lab", "makerspace", "manufacturing_plant",
            "prototype_lab", "assembly_facility", "research_lab", "production_facility"
        ]
    ...
    def _is_valid_equipment_type(self, equipment_type: str) -> bool:
        ...
        valid_types = [
            "cnc_mill", "cnc_lathe", "3d_printer", "laser_cutter", "water_jet",
            "injection_molding", "press_brake", "welder", "assembly_station",
            "quality_control", "packaging", "material_handling"
        ]
    ...
    def _is_valid_material_type(self, material_type: str) -> bool:
        ...
        valid_materials = [
            "aluminum", "steel", "plastic", "wood", "ceramic", "composite",
            "titanium", "brass", "copper", "stainless_steel", "carbon_fiber"
        ]
    ...
    def _is_valid_certification(self, certification: str) -> bool:
        ...
        valid_certifications = [
            "ISO 9001", "ISO 14001", "ISO 13485", "AS9100", "IATF 16949",
            "FDA", "CE", "UL", "CSA", "TUV", "DNV", "ABS"
        ]
