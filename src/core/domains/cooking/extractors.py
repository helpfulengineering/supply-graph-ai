...
class CookingExtractor(BaseExtractor):
    ...
    def _detailed_extract_requirements(self, parsed_data: Dict[str, Any]) -> NormalizedRequirements:
        ...
        has_okh_fields = "tool_list" in parsed_data or "making_instructions" in parsed_data
        ...
        if has_okh_fields:
            ...
            for material in materials:
                if isinstance(material, dict):
                    ...
                    material_name = material.get("name") or material.get("material_type") or material.get("identifier", "")
                    if material_name:
            ...
            for tool in tool_list:
                if isinstance(tool, str) and tool:
                    ...
                    tool_name = tool.get("name") or tool.get("tool") or tool.get("identifier", "")
                    if tool_name:
    ...
    def _detailed_extract_capabilities(self, parsed_data: Dict[str, Any]) -> NormalizedCapabilities:
        ...
        has_okw_fields = "typical_materials" in parsed_data or "equipment" in parsed_data
