...
@click.option('--no-quality-instructions', is_flag=True, help='Exclude technical specifications (includes quality instructions)')
...
@click.option('--no-tool-settings', is_flag=True, help='Exclude making instructions (includes tool settings)')
