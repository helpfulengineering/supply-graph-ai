...
describe("formatOkhDisplayTitle", () => {
  ...
  it("title-cases snake_case", () => {
    expect(formatOkhDisplayTitle("open_source_rover")).toBe(
      "Open Source Rover",
    );
  });
  ...
  it("preserves hardware acronyms", () => {
    expect(
      formatOkhDisplayTitle("3dp-iso-8655-compliant-multichannel-pipette"),
    ).toBe("3DP ISO 8655 Compliant Multichannel Pipette");
