...
export function NavBar() {
  ...
  // NavLink matched by path prefix (no `end` prop); preserved here.
    ...
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
      <div className="mx-auto flex max-w-7xl items-center gap-6 px-6 py-3">
        ...
        <nav className="flex gap-1" aria-label="Primary navigation">
          ...
          {/*
            A plain anchor, not a Link: /docs is a static mkdocs site served by
            the docs route handler on the same origin, not an app route.
            Client-side navigation would try to resolve it in the app and fail.
          */}
          <a
            href="/docs/"
