...
## LLM Response
{
  ...
  "capability_assessment": {
    ...
    "expertise_skills": {
      "score": 0.3,
      "analysis": "While both require precision work, electronics assembly skills don't transfer well to laser cutting operations. Different technical knowledge domains.",
      "training_needs": [
        "Complete laser cutting system operation training",
        "Material science for cutting operations",
  ...
  "key_factors": [
    ...
    "Lack of laser cutting equipment",
  ...
  "recommendations": [
    ...
    "Investigate if parts can be outsourced to appropriate facilities"
  ],
  "risks": [
    ...
    "No viable workarounds exist for this capability gap"
  ],
  "crisis_adaptability": "Even in crisis conditions, electronics assembly facility cannot be adapted for laser cutting. The fundamental capabilities and equipment required are too different. This is not a matter of adaptation but a complete mismatch in manufacturing domains."
}
