...
## LLM Response
{
  ...
  "capability_assessment": {
    "process_compatibility": {
      "score": 0.1,
      "analysis": "Metal processing facility lacks fundamental woodworking capabilities. Core processes (cutting, shaping, finishing) for hardwood are substantially different from metal processing.",
      "substitutions": ["No viable process substitutions - metal working equipment cannot safely or effectively process hardwood"]
    },
    "material_availability": {
      "score": 0.0,
      "analysis": "Complete mismatch between required material (hardwood) and facility's material expertise (metals). No overlap in material handling capabilities.",
      "substitutions": ["No viable material substitutions - metal cannot substitute for hardwood applications"]
    },
    "tool_equipment": {
      "score": 0.1,
      "analysis": "Metal processing equipment (metalworking tools, welding equipment, metal cutting machinery) is fundamentally incompatible with woodworking requirements",
      "adaptations": ["None viable - metal processing tools would damage wood and create safety hazards"]
    },
    "expertise_skills": {
      "score": 0.2,
      "analysis": "While some general manufacturing principles transfer, specific woodworking skills and knowledge are entirely different from metalworking",
      "training_needs": [
    ...
    "scale_capacity": {
      "score": 0.0,
      "analysis": "Scale capacity cannot be evaluated as fundamental process capability is missing",
      "scaling_options": ["Not applicable due to fundamental capability mismatch"]
    }
  },
  "overall_analysis": "This facility is fundamentally incompatible with hardwood processing. Metal processing requires entirely different tools, expertise, and safety protocols than woodworking. The risk of injury or equipment damage would be severe if attempted.",
  "key_factors": [
    "Complete process incompatibility between metal and wood processing",
    "Lack of appropriate tooling and equipment",
    "Absence of wood-specific safety measures and expertise",
    "Risk of serious injury or equipment damage if attempted"
  ],
  "recommendations": [
    "Seek alternative facility with woodworking capabilities",
    "Consider if final product could be redesigned for metal construction instead",
    "If wood processing is essential, facility would need complete retooling and retraining"
  ],
  "risks": [
    "Safety hazards from attempting to process wood with metal equipment",
    "Equipment damage from improper material processing",
    "Product quality would be impossible to achieve",
    "Workplace safety violations"
  ],
  "crisis_adaptability": "Even in crisis conditions, this facility cannot safely or effectively adapt to hardwood processing. The fundamental mismatch in materials and processes makes adaptation impossible without complete facility transformation."
}
