...
## LLM Response
{
  ...
  "capability_assessment": {
    "process_compatibility": {
      "score": 1.0,
      "analysis": "Direct material match - 304 stainless steel is exactly what's needed when generic 'stainless steel' is specified",
    ...
    "expertise_skills": {
      ...
      "training_needs": ["No additional training needed for basic SS work"]
    },
    "scale_capacity": {
      "score": 0.9,
      "analysis": "No specific scale requirements mentioned, facility likely capable of typical SS processing volumes",
      "scaling_options": ["Batch processing", "Continuous processing depending on form factor"]
    }
  },
  "overall_analysis": "This is a very strong match. The facility has 304 stainless steel, which is the most common grade of stainless steel and perfectly suitable for most general stainless steel requirements. Without more specific grade requirements being specified, 304 SS is the industry standard choice.",
  "key_factors": [
    "Direct material match with 304 SS",
    "Facility already works with stainless steel",
    "304 SS is suitable for most general SS applications"
  ],
  "recommendations": [
    "Proceed with production using 304 SS",
    "Verify if any specific grade requirements exist",
    "Document grade used for traceability"
  ],
  "risks": [
    "Generic 'stainless steel' requirement might later be refined with specific grade needs",
    "Some highly specialized applications might require different grades",
    "Corrosion resistance requirements might need verification if application is critical"
  ],
  "crisis_adaptability": "Excellent crisis adaptability. 304 SS is widely available, well-understood, and suitable for most applications. Facility can likely adapt to various production needs with existing capabilities."
}
