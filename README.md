...
**Current release:** `0.10.0` — see [CHANGELOG.md](CHANGELOG.md) and [Release process](docs/RELEASE.md).
...
```bash
docker pull touchthesun/openhardwaremanager:0.10.0
docker run -p 8001:8001 \
  -e STORAGE_PROVIDER=local \
  -e LLM_ENABLED=false \
  touchthesun/openhardwaremanager:0.10.0
```
