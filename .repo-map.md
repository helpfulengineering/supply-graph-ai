...
Package building takes file loc...

**Exports:** test_legitimate_package_paths_still_work, test_escaping_paths_are_rejected, test_a_symlinked_base_is_judged_on_where_it_lands, test_object_keys_stay_under_their_prefix, test_keys_cannot_escape_into_the_credential_prefix

**Functions:**
- `test_legitimate_package_paths_still_work(tmp_path, relative)`
  - The guard must not break normal packages, which do have subdirectories....
- `test_escaping_paths_are_rejected(tmp_path, relative)`
- `test_a_symlinked_base_is_judged_on_where_it_lands(tmp_path)`
  - Resolving both sides is what makes the comparison meaningful....
- `test_object_keys_stay_under_their_prefix(relative, expected)`
- `test_keys_cannot_escape_into_the_credential_prefix(relative)`
